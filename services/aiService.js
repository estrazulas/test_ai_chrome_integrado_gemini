export class AIService {
    ...
    async getParams() {
        // Como o params() foi depreciado, retornamos valores seguros manualmente
        // ou apenas informamos que a API é gerenciada internamente.
        console.log('LanguageModel.params() é legado. Usando configurações padrão.');
        return {
            defaultTopK: 3,
